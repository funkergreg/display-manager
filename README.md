...
- **Capture your current setup as a `Profile`** — the display layout (which monitors are active, which is primary, plus resolution and orientation) *and* the default audio device, saved under a name you choose.
